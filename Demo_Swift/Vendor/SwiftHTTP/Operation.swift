...
/**
All the things of an HTTP Response2
*/
open class Response2 {
    /// The header values in HTTP Response2.
    open var headers: Dictionary<String,String>?
    /// The mime type of the HTTP Response2.
    open var mimeType: String?
    /// The suggested filename for a downloaded file.
    open var suggestedFilename: String?
    /// The body data of the HTTP Response2.
    open var data: Data {
        return collectData as Data
    }
    /// The status code of the HTTP Response2.
    open var statusCode: Int?
    /// The URL of the HTTP Response2.
    open var URL: Foundation.URL?
    /// The Error of the HTTP Response2 (if there was one).
    open var error: Error?
    ///Returns the Response2 as a string
    open var text: String? {
        return  String(data: data, encoding: .utf8)
    }
    ///get the description of the Response2
    ...
    ///finish closure
    var completionHandler:((Response2) -> Void)?
    ...
    var downloadHandler:((Response2, URL) -> Void)?
...
open class HTTP {
    ...
    */
    open var onFinish:((Response2) -> Void)? {
        didSet {
            if let handler = onFinish {
                DelegateManager.sharedInstance.addTask(task, completionHandler: { (Response2: Response2) in
                    handler(Response2)
                })
            }
        }
    ...
    open var downloadHandler: ((Response2, URL) -> Void)? {
        set {
            guard let resp = DelegateManager.sharedInstance.responseForTask(task) else { return }
    ...
    */
    open func run(_ completionHandler: ((Response2) -> Void)? = nil) {
    ...
    */
    @discardableResult open class func GET(_ url: String, parameters: HTTPParameterProtocol? = nil, headers: [String:String]? = nil,
        requestSerializer: HTTPSerializeProtocol = HTTPParameterSerializer(), completionHandler: ((Response2) -> Void)? = nil) -> HTTP? {
    ...
    */
    @discardableResult open class func HEAD(_ url: String, parameters: HTTPParameterProtocol? = nil, headers: [String:String]? = nil, requestSerializer: HTTPSerializeProtocol = HTTPParameterSerializer(), completionHandler: ((Response2) -> Void)? = nil) -> HTTP? {
    ...
    */
    @discardableResult open class func DELETE(_ url: String, parameters: HTTPParameterProtocol? = nil, headers: [String:String]? = nil, requestSerializer: HTTPSerializeProtocol = HTTPParameterSerializer(), completionHandler: ((Response2) -> Void)? = nil) -> HTTP? {
    ...
    */
    @discardableResult open class func POST(_ url: String, parameters: HTTPParameterProtocol? = nil, headers: [String:String]? = nil, requestSerializer: HTTPSerializeProtocol = HTTPParameterSerializer(), completionHandler: ((Response2) -> Void)? = nil) -> HTTP? {
    ...
    */
    ...
    Class method to run a PUT request that handles the URLRequest and parameter encoding for you.
    */
    @discardableResult open class func PATCH(_ url: String, parameters: HTTPParameterProtocol? = nil, headers: [String:String]? = nil, requestSerializer: HTTPSerializeProtocol = HTTPParameterSerializer(), completionHandler: ((Response2) -> Void)? = nil) -> HTTP? {
    ...
    @discardableResult class func Run(_ url: String, method: HTTPVerb, parameters: HTTPParameterProtocol? = nil, headers: [String:String]? = nil, requestSerializer: HTTPSerializeProtocol = HTTPParameterSerializer(), completionHandler: ((Response2) -> Void)? = nil) -> HTTP?  {
    ...
    open class func Download(_ url: String, parameters: HTTPParameterProtocol? = nil, headers: [String:String]? = nil,
                             requestSerializer: HTTPSerializeProtocol = HTTPParameterSerializer(), completion:@escaping ((Response2, URL) -> Void)) {
    ...
    */
    open class func New(_ url: String, method: HTTPVerb, parameters: HTTPParameterProtocol? = nil, headers: [String:String]? = nil, requestSerializer: HTTPSerializeProtocol = HTTPParameterSerializer(), completionHandler: ((Response2) -> Void)? = nil) -> HTTP? {
...
public class DelegateManager: NSObject, URLSessionDataDelegate, URLSessionDownloadDelegate {
    ...
    var taskMap = Dictionary<Int,Response2>()
    //"install" a task by adding the task to the map and setting the completion handler
    func addTask(_ task: URLSessionTask, completionHandler:@escaping ((Response2) -> Void)) {
    ...
    //add the Response2 task
    func addResponseForTask(_ task: URLSessionTask) {
        if taskMap[task.taskIdentifier] == nil {
            taskMap[task.taskIdentifier] = Response2()
        }
    }
    //get the Response2 object for the task
    func responseForTask(_ task: URLSessionTask) -> Response2? {
    ...
    //handle progress
    public func progressHandler(_ Response2: Response2, expectedLength: Int64, currentLength: Int64) {
        guard let handler = Response2.progressHandler else { return }
        let slice = Float(1.0)/Float(expectedLength)
        handler(slice*Float(currentLength))
    }
    
    /**
    Create an error for Response2 you probably don't want (400-500 HTTP responses for example).
...
open class HTTPQueue {
    ...
    func run() {
        ...
        http.run {[weak self] (Response2) in
            handler?(Response2)
            self?.mutex.lock()
