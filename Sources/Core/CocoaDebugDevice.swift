...
public enum CocoaDebugDeviceModel : String {
...
public extension UIDevice {
    ...
    var cocoadebugDeviceType: CocoaDebugDeviceModel {
        ...
        let modelMap : [String: CocoaDebugDeviceModel] = [
        ...
        guard let mcode = modelCode, let map = String(validatingUTF8: mcode), let model = modelMap[map] else { return CocoaDebugDeviceModel.unrecognized }
        if model == .simulator {
