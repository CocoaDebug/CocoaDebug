 ...
 **/
@interface _GPBTimestampRoot : _GPBRootObject
@end

#pragma mark - _GPBTimestamp

typedef _GPB_ENUM(_GPBTimestamp_FieldNumber) {
  _GPBTimestamp_FieldNumber_Seconds = 1,
  _GPBTimestamp_FieldNumber_Nanos = 2,
};
 ...
 **/
@interface _GPBTimestamp : _GPBMessage
