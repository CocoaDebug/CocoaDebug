 ...
 **/
@interface _GPBAnyRoot : _GPBRootObject
@end

#pragma mark - _GPBAny

typedef _GPB_ENUM(_GPBAny_FieldNumber) {
  _GPBAny_FieldNumber_TypeURL = 1,
  _GPBAny_FieldNumber_Value = 2,
};
