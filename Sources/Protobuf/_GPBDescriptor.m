...
static NSArray *NewFieldsArrayForHasIndex(int hasIndex,
  ...
  for (_GPBFieldDescriptor *fieldDesc in allMessageFields) {
...
@implementation _GPBDescriptor {
  Class messageClass_;
  _GPBFileDescriptor *file_;
  BOOL wireFormat_;
}
...
+ (instancetype)
  ...
  _GPBFileSyntax syntax = file.syntax;
  BOOL fieldsIncludeDefault =
      (flags & _GPBDescriptorInitializationFlag_FieldsWithDefault) != 0;
  ...
  for (uint32_t i = 0; i < fieldCount; ++i) {
    ...
    if (fieldsIncludeDefault) {
      _GPBMessageFieldDescriptionWithDefault *fieldDescWithDefault = fieldDescriptions;
      desc = &(fieldDescWithDefault[i]);
    } else {
      _GPBMessageFieldDescription *fieldDesc = fieldDescriptions;
      desc = &(fieldDesc[i]);
    }
    _GPBFieldDescriptor *fieldDescriptor =
        [[_GPBFieldDescriptor alloc] initWithFieldDescription:desc
  ...
  BOOL wireFormat = (flags & _GPBDescriptorInitializationFlag_WireFormat) != 0;
  _GPBDescriptor *descriptor = [[self alloc] initWithClass:messageClass
                                                     file:file
                                                   fields:fields
...
- (void)setupOneofs:(const char **)oneofNames
  ...
  for (uint32_t i = 0, hasIndex = firstHasIndex; i < count; ++i, --hasIndex) {
    ...
    _GPBOneofDescriptor *oneofDescriptor =
        [[_GPBOneofDescriptor alloc] initWithName:name fields:fieldsForOneof];
...
- (void)setupExtraTextInfo:(const char *)extraTextFormatInfo {
  ...
  if (extraTextFormatInfo) {
    ...
    for (_GPBFieldDescriptor *fieldDescriptor in fields_) {
      if (fieldDescriptor->description_->flags & _GPBFieldTextFormatNameCustom) {
...
- (NSString *)fullName {
  ...
  _GPBFileDescriptor *file = self.file;
  ...
  _GPBDescriptor *parent = self.containingType;
...
- (_GPBFieldDescriptor *)fieldWithNumber:(uint32_t)fieldNumber {
  for (_GPBFieldDescriptor *descriptor in fields_) {
    if (_GPBFieldNumber(descriptor) == fieldNumber) {
      return descriptor;
    }
  }
  return nil;
...
- (_GPBFieldDescriptor *)fieldWithName:(NSString *)name {
  for (_GPBFieldDescriptor *descriptor in fields_) {
...
- (_GPBOneofDescriptor *)oneofWithName:(NSString *)name {
  for (_GPBOneofDescriptor *descriptor in oneofs_) {
    if ([descriptor.name isEqual:name]) {
      return descriptor;
    }
  }
...
@implementation _GPBFileDescriptor {
  NSString *package_;
  NSString *objcPrefix_;
  _GPBFileSyntax syntax_;
}
...
@implementation _GPBOneofDescriptor
...
- (instancetype)initWithName:(const char *)name fields:(NSArray *)fields {
  ...
  if (self) {
    name_ = name;
    fields_ = [fields retain];
    for (_GPBFieldDescriptor *fieldDesc in fields) {
...
uint32_t _GPBFieldTag(_GPBFieldDescriptor *self) {
  _GPBMessageFieldDescription *description = self->description_;
  _GPBWireFormat format;
  if ((description->flags & _GPBFieldMapKeyMask) != 0) {
    // Maps are repeated messages on the wire.
    format = _GPBWireFormatForType(_GPBDataTypeMessage, NO);
  } else {
    format = _GPBWireFormatForType(description->dataType,
                                  ((description->flags & _GPBFieldPacked) != 0));
  }
  return _GPBWireFormatMakeTag(description->number, format);
}

uint32_t _GPBFieldAlternateTag(_GPBFieldDescriptor *self) {
  _GPBMessageFieldDescription *description = self->description_;
  NSCAssert((description->flags & _GPBFieldRepeated) != 0,
            @"Only valid on repeated fields");
  _GPBWireFormat format =
      _GPBWireFormatForType(description->dataType,
                           ((description->flags & _GPBFieldPacked) == 0));
  return _GPBWireFormatMakeTag(description->number, format);
}

@implementation _GPBFieldDescriptor {
  _GPBGenericValue defaultValue_;
  ...
  union {
    _GPBEnumDescriptor *enumDescriptor_;
    _GPBEnumValidationFunc enumVerifier_;
  } enumHandling_;
}
...
- (instancetype)initWithFieldDescription:(void *)description
                         includesDefault:(BOOL)includesDefault
                                  syntax:(_GPBFileSyntax)syntax {
  if ((self = [super init])) {
    _GPBMessageFieldDescription *coreDesc;
    if (includesDefault) {
      coreDesc = &(((_GPBMessageFieldDescriptionWithDefault *)description)->core);
    } else {
    ...
    _GPBDataType dataType = coreDesc->dataType;
    BOOL isMessage = _GPBDataTypeIsMessage(dataType);
    BOOL isMapOrArray = _GPBFieldIsMapOrArray(self);
    ...
    if (isMapOrArray) {
      ...
      if ((coreDesc->hasIndex >= 0) &&
          (coreDesc->hasIndex != _GPBNoHasBit) &&
          ((syntax != _GPBFileSyntaxProto3) || isMessage)) {
    ...
    } else if (dataType == _GPBDataTypeEnum) {
      if ((coreDesc->flags & _GPBFieldHasEnumDescriptor) != 0) {
    ...
    if (!isMapOrArray && includesDefault) {
      defaultValue_ = ((_GPBMessageFieldDescriptionWithDefault *)description)->defaultValue;
      if (dataType == _GPBDataTypeBytes) {
...
- (void)dealloc {
  if (description_->dataType == _GPBDataTypeBytes &&
      !(description_->flags & _GPBFieldRepeated)) {
...
- (BOOL)hasDefaultValue {
  return (description_->flags & _GPBFieldHasDefaultValue) != 0;
}
...
- (BOOL)isRequired {
  return (description_->flags & _GPBFieldRequired) != 0;
}

- (BOOL)isOptional {
  return (description_->flags & _GPBFieldOptional) != 0;
}

- (_GPBFieldType)fieldType {
  _GPBFieldFlags flags = description_->flags;
  if ((flags & _GPBFieldRepeated) != 0) {
    return _GPBFieldTypeRepeated;
  } else if ((flags & _GPBFieldMapKeyMask) != 0) {
    return _GPBFieldTypeMap;
  } else {
    return _GPBFieldTypeSingle;
  }
}

- (_GPBDataType)mapKeyDataType {
  switch (description_->flags & _GPBFieldMapKeyMask) {
    case _GPBFieldMapKeyInt32:
      return _GPBDataTypeInt32;
    case _GPBFieldMapKeyInt64:
      return _GPBDataTypeInt64;
    case _GPBFieldMapKeyUInt32:
      return _GPBDataTypeUInt32;
    case _GPBFieldMapKeyUInt64:
      return _GPBDataTypeUInt64;
    case _GPBFieldMapKeySInt32:
      return _GPBDataTypeSInt32;
    case _GPBFieldMapKeySInt64:
      return _GPBDataTypeSInt64;
    case _GPBFieldMapKeyFixed32:
      return _GPBDataTypeFixed32;
    case _GPBFieldMapKeyFixed64:
      return _GPBDataTypeFixed64;
    case _GPBFieldMapKeySFixed32:
      return _GPBDataTypeSFixed32;
    case _GPBFieldMapKeySFixed64:
      return _GPBDataTypeSFixed64;
    case _GPBFieldMapKeyBool:
      return _GPBDataTypeBool;
    case _GPBFieldMapKeyString:
      return _GPBDataTypeString;

    default:
      NSAssert(0, @"Not a map type");
      return _GPBDataTypeInt32;  // For lack of anything better.
  }
}

- (BOOL)isPackable {
  return (description_->flags & _GPBFieldPacked) != 0;
}

- (BOOL)isValidEnumValue:(int32_t)value {
  NSAssert(description_->dataType == _GPBDataTypeEnum,
           @"Field Must be of type _GPBDataTypeEnum");
  if (description_->flags & _GPBFieldHasEnumDescriptor) {
...
- (_GPBEnumDescriptor *)enumDescriptor {
  if (description_->flags & _GPBFieldHasEnumDescriptor) {
...
- (_GPBGenericValue)defaultValue {
  ...
  _GPBGenericValue value = defaultValue_;

  if (!(description_->flags & _GPBFieldRepeated)) {
    // We special handle data and strings. If they are nil, we replace them
    // with empty string/empty data.
    _GPBDataType type = description_->dataType;
    if (type == _GPBDataTypeBytes && value.valueData == nil) {
      value.valueData = _GPBEmptyNSData();
    } else if (type == _GPBDataTypeString && value.valueString == nil) {
      value.valueString = @"";
    }
  }
  return value;
...
- (NSString *)textFormatName {
  if ((description_->flags & _GPBFieldTextFormatNameCustom) != 0) {
    ...
    return _GPBDecodeTextFormatName(extraTextFormatInfo, _GPBFieldNumber(self),
                                   self.name);
  }
  ...
  if (((description_->flags & _GPBFieldRepeated) != 0) &&
...
@implementation _GPBEnumDescriptor {
  NSString *name_;
...
+ (instancetype)
  ...
  _GPBEnumDescriptor *descriptor = [[self alloc] initWithName:name
...
+ (instancetype)
  ...
  _GPBEnumDescriptor *descriptor = [self allocDescriptorForName:name
                                                    valueNames:valueNames
                                                        values:values
                                                         count:valueCount
                                                  enumVerifier:enumVerifier];
...
- (NSString *)getEnumTextFormatNameForIndex:(uint32_t)index {
  ...
  if (extraTextFormatInfo_) {
    result = _GPBDecodeTextFormatName(extraTextFormatInfo_,
...
@implementation _GPBExtensionDescriptor {
  _GPBGenericValue defaultValue_;
}
...
- (instancetype)initWithExtensionDescription:
  ...
  if ((self = [super init])) {
    ...
    } else if (type == _GPBDataTypeMessage || type == _GPBDataTypeGroup) {
...
- (void)dealloc {
  if ((description_->dataType == _GPBDataTypeBytes) &&
      !_GPBExtensionIsRepeated(description_)) {
    [defaultValue_.valueData release];
  }
  [super dealloc];
}
...
- (_GPBWireFormat)wireType {
  return _GPBWireFormatForType(description_->dataType,
                              _GPBExtensionIsPacked(description_));
}

- (_GPBWireFormat)alternateWireType {
  NSAssert(_GPBExtensionIsRepeated(description_),
...
- (BOOL)isRepeated {
  return _GPBExtensionIsRepeated(description_);
}

- (BOOL)isPackable {
  return _GPBExtensionIsPacked(description_);
}
...
- (_GPBEnumDescriptor *)enumDescriptor {
  if (description_->dataType == _GPBDataTypeEnum) {
    _GPBEnumDescriptor *enumDescriptor = description_->enumDescriptorFunc();
...
- (id)defaultValue {
  if (_GPBExtensionIsRepeated(description_)) {
    return nil;
  }
