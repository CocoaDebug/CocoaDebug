 ...
 **/
@interface _GPBFieldMaskRoot : _GPBRootObject
@end

#pragma mark - _GPBFieldMask

typedef _GPB_ENUM(_GPBFieldMask_FieldNumber) {
  _GPBFieldMask_FieldNumber_PathsArray = 1,
};
 ...
 **/
@interface _GPBFieldMask : _GPBMessage
