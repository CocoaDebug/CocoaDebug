...
@class _GPBBoolArray;
@class _GPBDoubleArray;
@class _GPBEnumArray;
@class _GPBFloatArray;
@class _GPBMessage;
@class _GPBInt32Array;
@class _GPBInt64Array;
...
/**
 * @c _GPBCodedOutputStream exception names.
 **/
extern NSString *const _GPBCodedOutputStreamException_OutOfSpace;
extern NSString *const _GPBCodedOutputStreamException_WriteFailed;

/**
 * Writes out protocol message fields.
 *
 * The common uses of protocol buffers shouldn't need to use this class.
 * _GPBMessage's provide a -data method that will serialize the message for you.
 *
 * @note Any -write* api can raise the _GPBCodedOutputStreamException_*
 *       exceptions.
 *
 * @note Subclassing of _GPBCodedOutputStream is NOT supported.
 **/
@interface _GPBCodedOutputStream : NSObject
 ...
 *
 * @return A newly instanced _GPBCodedOutputStream.
 **/
 ...
 * @param data The data where the stream will be written to.
 *
 * @return A newly initialized _GPBCodedOutputStream.
 **/
...
/**
 * Write a _GPBMessage for the given field number.
 *
 * @param fieldNumber The field number assigned to the value.
 * @param value       The value to write out.
 **/
...
/**
 * Write an array of _GPBMessage for the given field number.
 *
 * @param fieldNumber The field number assigned to the values.
 * @param values      The values to write out.
 **/
- (void)writeMessageArray:(int32_t)fieldNumber values:(NSArray<_GPBMessage*> *)values;
/**
 * Write a _GPBMessage without any tag.
 *
 * @param value The value to write out.
 **/
 ...
 * @param values      The values to write out.
 **/
- (void)writeGroupArray:(int32_t)fieldNumber values:(NSArray<_GPBMessage*> *)values;
/**
 * Write a _GPBMessage without any tag (but does write the endGroup tag).
 *
 * @param fieldNumber The field number assigned to the value.
 * @param value       The value to write out.
 **/
...
/**
 * Write a _GPBUnknownFieldSet for the given field number.
 *
 * @param fieldNumber The field number assigned to the value.
 * @param value       The value to write out.
 **/
...
/**
 * Write an array of _GPBUnknownFieldSet for the given field number.
 *
 * @param fieldNumber The field number assigned to the values.
 * @param values      The values to write out.
 **/
- (void)writeUnknownGroupArray:(int32_t)fieldNumber values:(NSArray<_GPBUnknownFieldSet*> *)values;
/**
 * Write a _GPBUnknownFieldSet without any tag (but does write the endGroup tag).
 *
 * @param fieldNumber The field number assigned to the value.
 * @param value       The value to write out.
 **/
...
*/
- (void)writeMessageSetExtension:(int32_t)fieldNumber value:(_GPBMessage *)value;
...
//%_WRITE_UNPACKABLE_DECLS(Message, _GPBMessage)
//%_WRITE_UNPACKABLE_DECLS(Bytes, NSData)
//%_WRITE_GROUP_DECLS(Group, _GPBMessage)
//%_WRITE_GROUP_DECLS(UnknownGroup, _GPBUnknownFieldSet)
