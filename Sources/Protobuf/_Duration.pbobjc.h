 ...
 **/
@interface _GPBDurationRoot : _GPBRootObject
@end

#pragma mark - _GPBDuration

typedef _GPB_ENUM(_GPBDuration_FieldNumber) {
  _GPBDuration_FieldNumber_Seconds = 1,
  _GPBDuration_FieldNumber_Nanos = 2,
};
 ...
 **/
@interface _GPBDuration : _GPBMessage
