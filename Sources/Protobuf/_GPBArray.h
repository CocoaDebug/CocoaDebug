 ...
 **/
@interface _GPBInt32Array : NSObject <NSCopying>

/** The number of elements contained in the array. */
@property(nonatomic, readonly) NSUInteger count;

/**
 * @return A newly instanced and empty _GPBInt32Array.
 **/
+ (instancetype)array;

/**
 * Creates and initializes a _GPBInt32Array with the single element given.
 *
 * @param value The value to be placed in the array.
 *
 * @return A newly instanced _GPBInt32Array with value in it.
 **/
+ (instancetype)arrayWithValue:(int32_t)value;

/**
 * Creates and initializes a _GPBInt32Array with the contents of the given
 * array.
 *
 * @param array Array with the contents to be put into the new array.
 *
 * @return A newly instanced _GPBInt32Array with the contents of array.
 **/
+ (instancetype)arrayWithValueArray:(_GPBInt32Array *)array;

/**
 * Creates and initializes a _GPBInt32Array with the given capacity.
 *
 * @param count The capacity needed for the array.
 *
 * @return A newly instanced _GPBInt32Array with a capacity of count.
 **/
+ (instancetype)arrayWithCapacity:(NSUInteger)count;

/**
 * @return A newly initialized and empty _GPBInt32Array.
 **/
 ...
 *
 * @return A newly initialized _GPBInt32Array with a copy of the values.
 **/
 ...
 * @param count The capacity needed for the array.
 *
 * @return A newly initialized _GPBInt32Array with a capacity of count.
 **/
 ...
 * @note This class is not meant to be subclassed.
 **/
@interface _GPBUInt32Array : NSObject <NSCopying>

/** The number of elements contained in the array. */
@property(nonatomic, readonly) NSUInteger count;

/**
 * @return A newly instanced and empty _GPBUInt32Array.
 **/
+ (instancetype)array;

/**
 * Creates and initializes a _GPBUInt32Array with the single element given.
 *
 * @param value The value to be placed in the array.
 *
 * @return A newly instanced _GPBUInt32Array with value in it.
 **/
+ (instancetype)arrayWithValue:(uint32_t)value;

/**
 * Creates and initializes a _GPBUInt32Array with the contents of the given
 * array.
 *
 * @param array Array with the contents to be put into the new array.
 *
 * @return A newly instanced _GPBUInt32Array with the contents of array.
 **/
+ (instancetype)arrayWithValueArray:(_GPBUInt32Array *)array;

/**
 * Creates and initializes a _GPBUInt32Array with the given capacity.
 *
 * @param count The capacity needed for the array.
 *
 * @return A newly instanced _GPBUInt32Array with a capacity of count.
 **/
+ (instancetype)arrayWithCapacity:(NSUInteger)count;

/**
 * @return A newly initialized and empty _GPBUInt32Array.
 **/
- (instancetype)init NS_DESIGNATED_INITIALIZER;
 ...
 * @param count  The number of elements to copy into the array.
 *
 * @return A newly initialized _GPBUInt32Array with a copy of the values.
 **/
 ...
 * @param count The capacity needed for the array.
 *
 * @return A newly initialized _GPBUInt32Array with a capacity of count.
 **/
- (instancetype)initWithCapacity:(NSUInteger)count;
 ...
 * @note This class is not meant to be subclassed.
 **/
@interface _GPBInt64Array : NSObject <NSCopying>

/** The number of elements contained in the array. */
@property(nonatomic, readonly) NSUInteger count;

/**
 * @return A newly instanced and empty _GPBInt64Array.
 **/
+ (instancetype)array;

/**
 * Creates and initializes a _GPBInt64Array with the single element given.
 *
 * @param value The value to be placed in the array.
 *
 * @return A newly instanced _GPBInt64Array with value in it.
 **/
+ (instancetype)arrayWithValue:(int64_t)value;

/**
 * Creates and initializes a _GPBInt64Array with the contents of the given
 * array.
 *
 * @param array Array with the contents to be put into the new array.
 *
 * @return A newly instanced _GPBInt64Array with the contents of array.
 **/
+ (instancetype)arrayWithValueArray:(_GPBInt64Array *)array;

/**
 * Creates and initializes a _GPBInt64Array with the given capacity.
 *
 * @param count The capacity needed for the array.
 *
 * @return A newly instanced _GPBInt64Array with a capacity of count.
 **/
+ (instancetype)arrayWithCapacity:(NSUInteger)count;

/**
 * @return A newly initialized and empty _GPBInt64Array.
 **/
- (instancetype)init NS_DESIGNATED_INITIALIZER;
 ...
 * @param count  The number of elements to copy into the array.
 *
 * @return A newly initialized _GPBInt64Array with a copy of the values.
 **/
 ...
 * @param count The capacity needed for the array.
 *
 * @return A newly initialized _GPBInt64Array with a capacity of count.
 **/
- (instancetype)initWithCapacity:(NSUInteger)count;
 ...
 * @note This class is not meant to be subclassed.
 **/
@interface _GPBUInt64Array : NSObject <NSCopying>

/** The number of elements contained in the array. */
@property(nonatomic, readonly) NSUInteger count;

/**
 * @return A newly instanced and empty _GPBUInt64Array.
 **/
+ (instancetype)array;

/**
 * Creates and initializes a _GPBUInt64Array with the single element given.
 *
 * @param value The value to be placed in the array.
 *
 * @return A newly instanced _GPBUInt64Array with value in it.
 **/
+ (instancetype)arrayWithValue:(uint64_t)value;

/**
 * Creates and initializes a _GPBUInt64Array with the contents of the given
 * array.
 *
 * @param array Array with the contents to be put into the new array.
 *
 * @return A newly instanced _GPBUInt64Array with the contents of array.
 **/
+ (instancetype)arrayWithValueArray:(_GPBUInt64Array *)array;

/**
 * Creates and initializes a _GPBUInt64Array with the given capacity.
 *
 * @param count The capacity needed for the array.
 *
 * @return A newly instanced _GPBUInt64Array with a capacity of count.
 **/
+ (instancetype)arrayWithCapacity:(NSUInteger)count;

/**
 * @return A newly initialized and empty _GPBUInt64Array.
 **/
- (instancetype)init NS_DESIGNATED_INITIALIZER;
 ...
 * @param count  The number of elements to copy into the array.
 *
 * @return A newly initialized _GPBUInt64Array with a copy of the values.
 **/
 ...
 * @param count The capacity needed for the array.
 *
 * @return A newly initialized _GPBUInt64Array with a capacity of count.
 **/
- (instancetype)initWithCapacity:(NSUInteger)count;
 ...
 * @note This class is not meant to be subclassed.
 **/
@interface _GPBFloatArray : NSObject <NSCopying>

/** The number of elements contained in the array. */
@property(nonatomic, readonly) NSUInteger count;

/**
 * @return A newly instanced and empty _GPBFloatArray.
 **/
+ (instancetype)array;

/**
 * Creates and initializes a _GPBFloatArray with the single element given.
 *
 * @param value The value to be placed in the array.
 *
 * @return A newly instanced _GPBFloatArray with value in it.
 **/
+ (instancetype)arrayWithValue:(float)value;

/**
 * Creates and initializes a _GPBFloatArray with the contents of the given
 * array.
 *
 * @param array Array with the contents to be put into the new array.
 *
 * @return A newly instanced _GPBFloatArray with the contents of array.
 **/
+ (instancetype)arrayWithValueArray:(_GPBFloatArray *)array;

/**
 * Creates and initializes a _GPBFloatArray with the given capacity.
 *
 * @param count The capacity needed for the array.
 *
 * @return A newly instanced _GPBFloatArray with a capacity of count.
 **/
+ (instancetype)arrayWithCapacity:(NSUInteger)count;

/**
 * @return A newly initialized and empty _GPBFloatArray.
 **/
- (instancetype)init NS_DESIGNATED_INITIALIZER;
 ...
 * @param count  The number of elements to copy into the array.
 *
 * @return A newly initialized _GPBFloatArray with a copy of the values.
 **/
 ...
 * @param count The capacity needed for the array.
 *
 * @return A newly initialized _GPBFloatArray with a capacity of count.
 **/
- (instancetype)initWithCapacity:(NSUInteger)count;
 ...
 * @note This class is not meant to be subclassed.
 **/
@interface _GPBDoubleArray : NSObject <NSCopying>

/** The number of elements contained in the array. */
@property(nonatomic, readonly) NSUInteger count;

/**
 * @return A newly instanced and empty _GPBDoubleArray.
 **/
+ (instancetype)array;

/**
 * Creates and initializes a _GPBDoubleArray with the single element given.
 *
 * @param value The value to be placed in the array.
 *
 * @return A newly instanced _GPBDoubleArray with value in it.
 **/
+ (instancetype)arrayWithValue:(double)value;

/**
 * Creates and initializes a _GPBDoubleArray with the contents of the given
 * array.
 *
 * @param array Array with the contents to be put into the new array.
 *
 * @return A newly instanced _GPBDoubleArray with the contents of array.
 **/
+ (instancetype)arrayWithValueArray:(_GPBDoubleArray *)array;

/**
 * Creates and initializes a _GPBDoubleArray with the given capacity.
 *
 * @param count The capacity needed for the array.
 *
 * @return A newly instanced _GPBDoubleArray with a capacity of count.
 **/
+ (instancetype)arrayWithCapacity:(NSUInteger)count;

/**
 * @return A newly initialized and empty _GPBDoubleArray.
 **/
- (instancetype)init NS_DESIGNATED_INITIALIZER;
 ...
 * @param count  The number of elements to copy into the array.
 *
 * @return A newly initialized _GPBDoubleArray with a copy of the values.
 **/
 ...
 * @param count The capacity needed for the array.
 *
 * @return A newly initialized _GPBDoubleArray with a capacity of count.
 **/
- (instancetype)initWithCapacity:(NSUInteger)count;
 ...
 * @note This class is not meant to be subclassed.
 **/
@interface _GPBBoolArray : NSObject <NSCopying>

/** The number of elements contained in the array. */
@property(nonatomic, readonly) NSUInteger count;

/**
 * @return A newly instanced and empty _GPBBoolArray.
 **/
+ (instancetype)array;

/**
 * Creates and initializes a _GPBBoolArray with the single element given.
 *
 * @param value The value to be placed in the array.
 *
 * @return A newly instanced _GPBBoolArray with value in it.
 **/
+ (instancetype)arrayWithValue:(BOOL)value;

/**
 * Creates and initializes a _GPBBoolArray with the contents of the given
 * array.
 *
 * @param array Array with the contents to be put into the new array.
 *
 * @return A newly instanced _GPBBoolArray with the contents of array.
 **/
+ (instancetype)arrayWithValueArray:(_GPBBoolArray *)array;

/**
 * Creates and initializes a _GPBBoolArray with the given capacity.
 *
 * @param count The capacity needed for the array.
 *
 * @return A newly instanced _GPBBoolArray with a capacity of count.
 **/
+ (instancetype)arrayWithCapacity:(NSUInteger)count;

/**
 * @return A newly initialized and empty _GPBBoolArray.
 **/
- (instancetype)init NS_DESIGNATED_INITIALIZER;
 ...
 * @param count  The number of elements to copy into the array.
 *
 * @return A newly initialized _GPBBoolArray with a copy of the values.
 **/
 ...
 * @param count The capacity needed for the array.
 *
 * @return A newly initialized _GPBBoolArray with a capacity of count.
 **/
- (instancetype)initWithCapacity:(NSUInteger)count;
 ...
 * @note This class is not meant to be subclassed.
 **/
@interface _GPBEnumArray : NSObject <NSCopying>

/** The number of elements contained in the array. */
@property(nonatomic, readonly) NSUInteger count;
/** The validation function to check if the enums are valid. */
@property(nonatomic, readonly) _GPBEnumValidationFunc validationFunc;

/**
 * @return A newly instanced and empty _GPBEnumArray.
 **/
+ (instancetype)array;

/**
 * Creates and initializes a _GPBEnumArray with the enum validation function
 * given.
 *
 * @param func The enum validation function for the array.
 *
 * @return A newly instanced _GPBEnumArray.
 **/
+ (instancetype)arrayWithValidationFunction:(nullable _GPBEnumValidationFunc)func;
...
/**
 * Creates and initializes a _GPBEnumArray that adds the elements from the
 * given array.
 *
...
/**
 * Creates and initializes a _GPBEnumArray with the given enum validation
 * function and with the givencapacity.
 *
 * @param func  The enum validation function for the array.
 * @param count The capacity needed for the array.
 *
 * @return A newly instanced _GPBEnumArray with a capacity of count.
 **/
+ (instancetype)arrayWithValidationFunction:(nullable _GPBEnumValidationFunc)func
 ...
 * @param func The enum validation function for the array.
 *
 * @return A newly initialized _GPBEnumArray with a copy of the values.
 **/
- (instancetype)initWithValidationFunction:(nullable _GPBEnumValidationFunc)func
 ...
 * @param count The capacity needed for the array.
 *
 * @return A newly initialized _GPBEnumArray with a capacity of count.
 **/
- (instancetype)initWithValidationFunction:(nullable _GPBEnumValidationFunc)func
                                  capacity:(NSUInteger)count;

// These will return k_GPBUnrecognizedEnumeratorValue if the value at index is not a
...
//% * @note This class is not meant to be subclassed.
//% **/
//%@interface _GPB##NAME##Array : NSObject <NSCopying>
//%
//%/** The number of elements contained in the array. */
//%@property(nonatomic, readonly) NSUInteger count;
//%
//%/**
//% * @return A newly instanced and empty _GPB##NAME##Array.
//% **/
//%+ (instancetype)array;
//%
//%/**
//% * Creates and initializes a _GPB##NAME##Array with the single element given.
//% *
//% * @param value The value to be placed in the array.
//% *
//% * @return A newly instanced _GPB##NAME##Array with value in it.
//% **/
//%+ (instancetype)arrayWithValue:(TYPE)value;
//%
//%/**
//% * Creates and initializes a _GPB##NAME##Array with the contents of the given
//% * array.
//% *
//% * @param array Array with the contents to be put into the new array.
//% *
//% * @return A newly instanced _GPB##NAME##Array with the contents of array.
//% **/
//%+ (instancetype)arrayWithValueArray:(_GPB##NAME##Array *)array;
//%
//%/**
//% * Creates and initializes a _GPB##NAME##Array with the given capacity.
//% *
//% * @param count The capacity needed for the array.
//% *
//% * @return A newly instanced _GPB##NAME##Array with a capacity of count.
//% **/
//%+ (instancetype)arrayWithCapacity:(NSUInteger)count;
//%
//%/**
//% * @return A newly initialized and empty _GPB##NAME##Array.
//% **/
//%- (instancetype)init NS_DESIGNATED_INITIALIZER;
//%
//%/**
...
//% * @param count  The number of elements to copy into the array.
//% *
//% * @return A newly initialized _GPB##NAME##Array with a copy of the values.
//% **/
...
//% * @param count The capacity needed for the array.
//% *
//% * @return A newly initialized _GPB##NAME##Array with a capacity of count.
//% **/
//%- (instancetype)initWithCapacity:(NSUInteger)count;
//%
...
//%
//%/**
//% * Creates and initializes a _GPB##NAME##Array with the enum validation function
//% * given.
//% *
//% * @param func The enum validation function for the array.
//% *
//% * @return A newly instanced _GPB##NAME##Array.
//% **/
//%+ (instancetype)arrayWithValidationFunction:(nullable _GPBEnumValidationFunc)func;
//%
//%/**
...
//%
//%/**
//% * Creates and initializes a _GPB##NAME##Array that adds the elements from the
//% * given array.
//% *
//% * @param array Array containing the values to add to the new array.
//% *
...
//%
//%/**
//% * Creates and initializes a _GPB##NAME##Array with the given enum validation
//% * function and with the givencapacity.
//% *
//% * @param func  The enum validation function for the array.
//% * @param count The capacity needed for the array.
...
//% * @param array The array containing the elements to add to this array.
//% **/
//%- (void)addValuesFromArray:(_GPB##NAME##Array *)array;
//%
...
//% * @param array Array containing the raw enum values to add to this array.
//% **/
//%- (void)addRawValuesFromArray:(_GPB##NAME##Array *)array;
//%
//%/**
//% * Adds raw enum values to this array.
//% *
