...
{
//    BOOL previouslyEnabled = [self isEnabled]; //liman
    
//    [[NSUserDefaults standardUserDefaults] setBool:enabled forKey:kFLEXNetworkObserverEnabledDefaultsKey]; //liman
    [NetworkHelper shared].isEnable = enabled;
...
+ (BOOL)isEnabled
{
//    return [[[NSUserDefaults standardUserDefaults] objectForKey:kFLEXNetworkObserverEnabledDefaultsKey] boolValue]; //liman
    return [NetworkHelper shared].isEnable;
}
