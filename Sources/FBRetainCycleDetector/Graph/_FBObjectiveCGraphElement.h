...
/**
 ...
 The Graph Element itself can only provide references from _FBAssociationManager.
 */
@interface _FBObjectiveCGraphElement : NSObject
...
/**
 ...
 (for example ivar names, struct references). For more check _FBObjectReference protocol.
 */
@property (nonatomic, copy, readonly, nullable) NSArray<NSString *> *namePath;
@property (nonatomic, weak, nullable) id object;
@property (nonatomic, readonly, nonnull) _FBObjectGraphConfiguration *configuration;
