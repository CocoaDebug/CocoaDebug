 ...
 **/
@interface _GPBSourceContextRoot : _GPBRootObject
@end

#pragma mark - _GPBSourceContext

typedef _GPB_ENUM(_GPBSourceContext_FieldNumber) {
  _GPBSourceContext_FieldNumber_FileName = 1,
};
 ...
 **/
@interface _GPBSourceContext : _GPBMessage
