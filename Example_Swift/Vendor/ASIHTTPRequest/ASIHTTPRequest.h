...
@property (nonatomic, retain) NSString *temporaryUncompressedDataDownloadPath;
@property (nonatomic, assign) SEL didStartSelector;
@property (nonatomic, assign) SEL didReceiveResponseHeadersSelector;
@property (nonatomic, assign) SEL willRedirectSelector;
...
@property (nonatomic, nonatomic, assign) NSTimeInterval persistentConnectionTimeoutSeconds;
...
@property (nonatomic, assign) id <ASICacheDelegate> downloadCache;
@property (nonatomic, assign) ASICachePolicy cachePolicy;
@property (nonatomic, assign) ASICacheStoragePolicy cacheStoragePolicy;
@property (nonatomic, assign, readonly) BOOL didUseCachedResponse;
...
#endif
@property (nonatomic, retain) ASIDataDecompressor *dataDecompressor;
@property (nonatomic, assign) BOOL shouldWaitToInflateCompressedResponses;
